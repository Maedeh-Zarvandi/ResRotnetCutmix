...
pretrained = './experiments/CIFAR10_RotNet_ResNet18/model_net_epoch30'
networks['feat_extractor'] = {'def_file': 'architectures/ResNet.py', 'pretrained': pretrained, 'opt': {'num_classes': 4, 'num_blocks':[2, 2, 2, 2]},  'optim_params': None} 

net_opt_cls = [None] * 4
net_opt_cls[0] = {'pool_type':'avg', 'nChannels':64, 'pool_size':1, 'num_classes': 10}
net_opt_cls[1] = {'pool_type':'avg', 'nChannels':128, 'pool_size':1, 'num_classes': 10}
net_opt_cls[2] = {'pool_type':'avg', 'nChannels':256, 'pool_size':1, 'num_classes': 10}
net_opt_cls[3] = {'pool_type':'avg', 'nChannels':512, 'pool_size':1, 'num_classes': 10}
out_feat_keys = ['conv1', 'conv2', 'conv3', 'conv4']
